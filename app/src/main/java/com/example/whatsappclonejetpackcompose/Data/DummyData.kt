package com.example.whats_app_clone_jetpackcompose.Data
...
class userDataRepository @Inject constructor() {
    fun getUserChats(id: Int):Chat?{
        return listChat().find{it.id == id}
    }

    fun getUserCall(id:Int):Call?{
        return listCall().find { it.id == id }
    }

//    fun getUserMessages(id: Int):Message?{
//        return listMessage().find { it.id == id }
//    }
    fun listChat() : List<Chat>{
        return listOf(
            Chat(
                id = 0,
                name = "Farhan Roy",
